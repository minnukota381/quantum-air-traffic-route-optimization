...
# === Parameters ===
X_DIM, Y_DIM, Z_DIM, T_MAX = 2, 2, 1, 2  # Reduced space to keep variables under ~400
...
# === Run the entire QUBO + QAOA optimization ===
if __name__ == "__main__":
    flights = [
        {"id": "F1", "start": (0, 0, 0, 0), "end": (2, 2, 0, 3)},
        {"id": "F2", "start": (2, 0, 1, 0), "end": (0, 2, 1, 3)},
    ]
